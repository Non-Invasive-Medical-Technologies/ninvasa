      ...
      <div className="bg-gradient-to-r from-medical-600 to-medical-800 text-white p-8 rounded-lg">
        <div className="max-w-4xl mx-auto text-center space-y-4">
          ...
          <div className="flex justify-center space-x-8 pt-8">
            <img src="/lovable-uploads/1a8e3902-3961-4b94-ac4d-30ae486e8d1d.png" alt="BL Medica Logo" className="h-16 object-contain bg-white/10 rounded-lg p-2" />
            <img src="/lovable-uploads/d1e24c32-9340-4528-8f24-f221be5a95a3.png" alt="Biopromin Logo" className="h-16 object-contain bg-white/10 rounded-lg p-2" />
          </div>
        </div>
      </div>
