...
const PresentationDeck = () => {
  return (
    <div className="w-full space-y-8">
      {/* Cover Slide */}
      <div className="bg-gradient-to-br from-medical-500 to-medical-600 text-white p-12 rounded-lg">
      ...
      <div className="bg-white p-8 rounded-lg shadow-lg">
        <h2 className="text-2xl font-bold text-medical-500 mb-6">Revolutionary Technology Platform</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {/* ANESA Overview */}
          <div className="p-6 bg-medical-50 rounded-lg">
            <div className="flex items-center mb-4">
              <Brain className="w-8 h-8 text-medical-500 mr-3" />
              <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center">
                <Shield className="w-5 h-5 text-medical-500 mr-2" />
          ...
          <div className="p-6 bg-medical-50 rounded-lg">
            <div className="flex items-center mb-4">
              <Heart className="w-8 h-8 text-medical-500 mr-3" />
              <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center">
                <Cloud className="w-5 h-5 text-medical-500 mr-2" />
      ...
      {/* Key Benefits */}
      <div className="bg-white p-8 rounded-lg shadow-lg">
        <h2 className="text-2xl font-bold text-medical-500 mb-6">Comprehensive Healthcare Solution</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="p-6 bg-gradient-to-br from-medical-50 to-white rounded-lg">
            <Shield className="w-8 h-8 text-medical-500 mb-3" />
          ...
          <div className="p-6 bg-gradient-to-br from-medical-50 to-white rounded-lg">
            <Brain className="w-8 h-8 text-medical-500 mb-3" />
          ...
          <div className="p-6 bg-gradient-to-br from-medical-50 to-white rounded-lg">
            <Cloud className="w-8 h-8 text-medical-500 mb-3" />
